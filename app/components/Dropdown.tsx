...
const Dropdown: React.FC<DropdownProps> = ({ color }) => {
  ...
  const btnDropdownRef = React.useRef<HTMLButtonElement>(null!); // Define the type here
  const popoverDropdownRef = React.useRef<HTMLDivElement>(null!); // Define the type here
